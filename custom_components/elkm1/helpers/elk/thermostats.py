"""Thermostat element and collection."""
...
SETTING_TYPING: dict[ThermostatSetting, type] = {
...
class Thermostat(Element):
    ...
    def set(
        self, element_to_set: ThermostatSetting, val: bool | int | ThermostatMode | ThermostatFan
    ) -> None:
        """Set one thermostat element (mode, hold, fan, or a setpoint)."""
...
class Thermostats(Elements[Thermostat]):
    ...
    def sync(self) -> None:
        """Request names for every thermostat."""
