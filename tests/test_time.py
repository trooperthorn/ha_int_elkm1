...
async def test_setup_entry_skips_non_time_of_day_settings(hass, mock_network_entry):
...
async def test_setup_entry_creates_entity_for_time_of_day_setting(hass, mock_network_entry):
